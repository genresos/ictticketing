...
Route::group(['namespace' => 'Api'], function () {
    ...
    Route::resource('tickets/{tickets}/comments', 'TicketsCommentController', [
        'only' => [
            'index', 'store', 'destroy'
        ]
    ]);
    ...
    Route::get('categorys', 'TicketCategoryController@index');
    Route::get('status', 'TicketStatusController@index');
    Route::get('priority', 'TicketPriorityController@index');
